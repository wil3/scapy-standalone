...
HG_NODE  = "$Node: f88d999102206f461f9c602708ea6d1be5ecfe7a $"
REVISION = "$Revision: f88d99910220 $"
...
#                loctrace.append((ip,loc)) # no labels yet
        ...
        tr = map(lambda x: Gnuplot.Data(x), trt.values())
        g = Gnuplot.Gnuplot()
        world = Gnuplot.File(conf.gnuplot_world)
        g.plot(world,*tr)
        return g
